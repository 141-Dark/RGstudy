	...
	<body>
		...
		<div class="login" style="margin-top:50px;">
			...
			<div class="web_qr_login" id="web_qr_login" style="display: block;">
				<div class="web_login">
					<form name="student_login" action="studentAndTeacherAdminLoginServlet.do?status=student" method="post" onsubmit="return login_studentID_username()">
					<input type="hidden" id="password" value="${password}"/>
			...
			<div class="qlogin" id="qlogin" style="display: none; ">
				<div class="web_login">
					<form name="teacher_login" id="regUser"  action="studentAndTeacherAdminLoginServlet.do?status=teacher" method="post" onsubmit="return login_teacherID_username()">
						<ul class="reg_form" id="reg-ul">
